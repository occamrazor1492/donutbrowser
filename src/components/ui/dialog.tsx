    ...
    <DialogPortal data-slot="dialog-portal">
      ...
      >
        <motion.div
          ...
          transition={transition}
          className={cn(
            "bg-background fixed top-[50%] left-[50%] z-10000 grid max-h-[calc(100dvh-2rem)] w-full max-w-[calc(100%-2rem)] translate-x-[-50%] translate-y-[-50%] gap-4 overflow-y-auto overscroll-contain rounded-lg border p-6 shadow-lg",
            className,
          )}
          {...props}
        >
